...
var noParameterAndNoReturnValue1 = {
    print("Hello!")
}

var noParameterAndReturnValue1 = { () -> Int in
    return 1000
}

var oneParameterAndReturnValue1 = { (x: Int) -> Int in
    return x % 10
}

var multipleParametersAndReturnValue1 =
...
var numbersF = [1, 2, 3, 4, 5, 6, 7, 8]

var evenNumbers = numbersF.filter { $0 % 2 == 0 }
// evenNumbers = [2, 4, 6, 8]

// Or remove all the even numbers:

var oddNumbers = numbersF.filter { $0 % 2 == 1 }
// oddNumbers = [1, 3, 5, 7]
...
var sumR = numbers.reduce(0) { $0 + $1 } // 15
...
var sumRed = numbers.reduce(0, +) // 15
